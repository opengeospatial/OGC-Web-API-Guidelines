:Title: OGC Web API Guidance
:titletext: OGC (Web API Guidance)
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
include::clause_6_REST.adoc[]

include::clause_7_OpenAPI.adoc[]

include::clause_8_Resources.adoc[]

include::clause_9_HTTP.adoc[]

include::clause_10_Filters.adoc[]

include::clause_11_API_Description.adoc[]
<<<
////
